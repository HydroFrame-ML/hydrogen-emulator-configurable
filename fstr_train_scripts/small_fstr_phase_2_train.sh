#!/bin/bash
#
#SBATCH --job-name=small_fstr_train_2
#SBATCH --output=log_small_fstr_train_2.txt
#
...
echo $CONFIG > config_small_fstr_phase_2.json
parflow_emulator --mode train --domain subsurface --config config_small_fstr_phase_2.json
