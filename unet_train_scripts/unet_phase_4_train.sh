#!/bin/bash
#
#SBATCH --job-name=unet_train_4
#SBATCH --output=log_unet_train_4.txt
#
...
echo $CONFIG > config_unet_phase_4.json
parflow_emulator --mode train --domain subsurface --config config_unet_phase_4.json
