#!/bin/bash
#
#SBATCH --job-name=resnet_train_2
#SBATCH --output=log_resnet_train_2.txt
#
...
echo $CONFIG > config_resnet_phase_2.json
parflow_emulator --mode train --domain subsurface --config config_resnet_phase_2.json