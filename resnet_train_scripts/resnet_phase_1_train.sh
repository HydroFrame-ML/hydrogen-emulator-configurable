#!/bin/bash
#
#SBATCH --job-name=resnet_train_1
#SBATCH --output=log_resnet_train_1.txt
#
...
echo $CONFIG > config_resnet_phase_1.json
parflow_emulator --mode train --domain subsurface --config config_resnet_phase_1.json
